    ...
    <div class="w-full bg-white rounded-xl p-2.5">
        <div class="border-2 border-gray-300 p-4 rounded-xl">
            <div class="flex justify-center flex-col">
                <span class="font-bold text-center text-3xl text-birumateri">DINSAL</span>
                <hr class="my-2">
            </div>
                ...
                if ((this.user.username != '') && (this.user.password != '')) {
                    axios.post('/admin/login', this.user).then(response => {
                        if (response.data == "Tidak terdaftar") {
                            this.$swal('Username belum terdaftar')
                    ...
                    this.$swal('Username atau Password tidak boleh kosong')
                }
            }
        }
