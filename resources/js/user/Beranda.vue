<template>
    <div class="flex flex-col items-center w-full">
        ...
        <div class="w-11/12 sm:mt-0 flex flex-col justify-center mt-4">
            ...
            >
                <input
                    ...
                    placeholder="Masukkan kegiatan yang ingin dicari"
                />
                <button
                    @click.prevent="cari()"
                    class="bg-hijaust hover:bg-green-900 focus:ring-4 px-4 py-1.5 text-white col-span-1 rounded-sm"
                >
                    Cari
                </button>
            </div>
        ...
        <div class="w-11/12 sm:mt-0 flex flex-col justify-center">
            <div class="font-bold text-xl mt-3">Daftar Proyek</div>
        </div>
        ...
        <div class="w-11/12 grid grid-cols-4 gap-2 justify-center">
            ...
            >
                <div
                    class="px-3 py-4 rounded-lg w-full flex justify-center items-center"
                >
                    <div class="text-xl font-semibold text-white text-center">
                        {{ dproyek["proyek"].nama.toUpperCase() }}
                    </div>
                </div>
            </button>
        </div>
